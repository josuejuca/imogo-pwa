...
const PreSelfieScreen = ({ navigation, route }) => {
    const { id, usuario_id } = route.params || {}; // Pegando o ID da rota
    ...
    const handleNext = () => {
        navigation.navigate('SelfieScreen', { id, usuario_id: usuario_id, classificacao: documento.classificacao, tipo: documento.tipo, tipo_documento: documento.tipo_documento });
    };
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            Vamos certificar a identidade do proprietário e comparar com o documento de identificação. #{id} | @{usuario_id}
            </Text>
